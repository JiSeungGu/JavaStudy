...
import java.net.*;
public class boyungListForm extends JPanel implements MouseListener{
    ...
    *    기능 => 메소드 ==> 리턴형 , 매개변수 
    */
   public boyungListForm()
   {
      setLayout(null);// FlowLayout => null 사용자 정의 배치
      b1=new JButton("제주 서귀포 카페");
      b2=new JButton("제주 중문단지 맛집");
      b3=new JButton("제주도 맛집 베스트");
      b4=new JButton("장어 맛집 베스트");
      b5=new JButton("호텔 빙수 베스트");
      b6=new JButton("검색");
